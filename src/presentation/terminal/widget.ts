...
import type { ConnectionState, QQConversationObserver, QQTerminalEvent } from "../../application/ports";

const WIDGET_KEY = "pi-agent-qqbot-conversation";
const STATUS_KEY = "pi-agent-qqbot";
